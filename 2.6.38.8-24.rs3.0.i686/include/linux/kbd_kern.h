...
#define VC_META		4	/* 0 - meta, 1 - meta=prefix with ESC */
	unsigned char input_mode:1;
#define NoKoMode	0	/* english input mode */
#define	KoMode		1	/* korean input mode */

	unsigned char kbd_layout:2;
#define	KP_KBD_STAND	0	/* kukui keyboard */
#define	KP_KBD_CHANGDOK	1	/* changdok keyboard */
#define	KP_KBD_BALUM	2	/* naenara balum keyboard */
};
